...
if(isset($_POST) && isset($_POST['origin']) && $_POST['origin'] == IV4T_postOrigin){
	require_once('includes/iv4t.php');
} elseif((isset($_REQUEST['original']) && isset($_REQUEST['original']) == 'yes')) {
	lilurl();
} else {
	lilurl();
}
	...
	<html>
		...
		<body onload="document.getElementById('longurl').focus()">
			...
			<form action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
				<fieldset>
					<input type="hidden" name="original" value="yes" />
